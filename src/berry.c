...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    .info = {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("It's extremely spicy. Few dare to"),
        .description2 = COMPOUND_STRING("try it, let alone eating one whole."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 40,
        .dry = 0,
        .sweet = 0,
        ...
        .berryPic = gBerryPic_Paprik,
        .berryPal = gBerryPalette_Paprik,
        .berryTreePicTable = gPicTable_PaprikBerryTree,
    ...
    .info = {
        ...
        .berryTreePicTable = gPicTable_EggantBerryTree,
    ...
    .info = {
        ...
        .berryTreePicTable = gPicTable_DrashBerryTree,
    ...
    .info = {
        ...
        .berryCrushDifficulty =  150,
        .berryCrushPowder =  300,
        .berryPic = gBerryPic_Skuash,
        .berryPal = gBerryPalette_Skuash,
        .berryTreePicTable = gPicTable_SkuashBerryTree,
    ...
    .info = {
        ...
        .berryTreePicTable = gPicTable_PumkinBerryTree,
    ...
    .info = {
        ...
        .berryCrushDifficulty =  150,
        .berryCrushPowder =  300,
        .berryPic = gBerryPic_Malium,
        .berryPal = gBerryPalette_Malium,
        .berryTreePicTable = gPicTable_MaliumBerryTree,
    ...
    .info = {
        ...
        .berryTreePicTable = gPicTable_TopoBerryTree,
    ...
    .info = {
        ...
        .berryTreePicTable = gPicTable_StribBerryTree,
    ...
    .info = {
        ...
        .berryCrushDifficulty =  150,
        .berryCrushPowder =  300,
        .berryPic = gBerryPic_Noion,
        .berryPal = gBerryPalette_Noion,
        .berryTreePicTable = gPicTable_NoionBerryTree,
    ...
    .info = {
        ...
        .berryTreePicTable = gPicTable_NutpeaBerryTree,
    ...
    [BERRY_ID_ROKA] =// E-reader Roka berry (Japanese exclusive Kuo berry)
    {
        ...
        .berryCrushDifficulty =  150,
        .berryCrushPowder =  300,
        .berryPic = gBerryPic_Roka,
        .berryPal = gBerryPalette_Roka,
        .berryTreePicTable = gPicTable_RokaBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Roka,
    },
