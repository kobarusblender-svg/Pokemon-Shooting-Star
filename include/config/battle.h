...
#define B_TRANSFORM_SEMI_INV_FAIL   GEN_1 // In Gen2+, Transform fails if the target is semi-invulnerable. //MOD CONTEST Oh boy, this will be fun :)
#define B_TRANSFORM_TARGET_FAIL     GEN_1 // In Gen2+, Transform fails if the target is already transformed. //MOD CONTEST Why nerf transform? let it be broken!
...
#define B_SPORT_BALL_MODIFIER       GEN_2 // In Gen8+, Sport Ball's catch multiplier was reduced from x1.5 to x1.
#define B_SAFARI_BALL_MODIFIER      GEN_2 // In Gen8+, Safari Ball's catch multiplier was reduced from x1.5 to x1.
#define B_FRIEND_BALL_MODIFIER      GEN_2 // In Gen8+, Friend Ball's friendship boost was reduced from 200 to 150.
