...
#define P_BALL_INHERITING              GEN_3                // Since Gen 6, Eggs from the Day Care will inherit the Poké Ball from their mother. From Gen 7 onwards, the father can pass it down as well, as long as it's of the same species as the mother.
...
#define P_CAN_FORGET_HIDDEN_MOVE         TRUE        // If TRUE, Pokémon can forget any move, even if it is an HM. //MOD CONTEST TODO make a pokemon who already learned an HM keep the function then.
