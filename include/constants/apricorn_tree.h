...
enum ApricornType
{
    ...
    /*APRICORN_BERRY_OCCA    = ITEM_OCCA_BERRY, //MOD CONTESt well... Thanks for that.
    APRICORN_BERRY_PASSHO  = ITEM_PASSHO_BERRY, //Now what do I do with my previous berry trees?
    ...
    APRICORN_BERRY_ENIGMA  = ITEM_ENIGMA_BERRY_E_READER,
