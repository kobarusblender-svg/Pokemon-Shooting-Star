...
{
    { TYPE_NORMAL,   MOVE_SCRATCH,         ITEM_STARF_BERRY, SPECIES_WOBBUFFET },
    { TYPE_FIGHTING, MOVE_KARATE_CHOP,     ITEM_STARF_BERRY, SPECIES_RAMPARDOS },
    { TYPE_FLYING,   MOVE_WING_ATTACK,     ITEM_STARF_BERRY,   SPECIES_HARIYAMA },
    { TYPE_POISON,   MOVE_POISON_STING,    ITEM_STARF_BERRY,  SPECIES_GOGOAT },
    { TYPE_GROUND,   MOVE_MUD_SHOT,        ITEM_STARF_BERRY,  SPECIES_RAMPARDOS },
    { TYPE_ROCK,     MOVE_ROCK_THROW,      ITEM_STARF_BERRY, SPECIES_CORVISQUIRE },
    { TYPE_BUG,      MOVE_BUG_BITE,        ITEM_STARF_BERRY,  SPECIES_WOBBUFFET },
    { TYPE_GHOST,    MOVE_SHADOW_PUNCH,    ITEM_STARF_BERRY,  SPECIES_WOBBUFFET },
    { TYPE_STEEL,    MOVE_METAL_CLAW,      ITEM_STARF_BERRY, SPECIES_RAMPARDOS },
    { TYPE_FIRE,     MOVE_EMBER,           ITEM_STARF_BERRY,   SPECIES_GOGOAT },
    { TYPE_WATER,    MOVE_WATER_GUN,       ITEM_STARF_BERRY, SPECIES_RAMPARDOS },
    { TYPE_GRASS,    MOVE_VINE_WHIP,       ITEM_STARF_BERRY,  SPECIES_RAMPARDOS },
    { TYPE_ELECTRIC, MOVE_THUNDER_SHOCK,   ITEM_STARF_BERRY,  SPECIES_CORVISQUIRE },
    { TYPE_PSYCHIC,  MOVE_CONFUSION,       ITEM_STARF_BERRY, SPECIES_HARIYAMA },
    { TYPE_ICE,      MOVE_AURORA_BEAM,     ITEM_STARF_BERRY,  SPECIES_DRAGONAIR },
    { TYPE_DRAGON,   MOVE_DRAGON_BREATH,   ITEM_STARF_BERRY,  SPECIES_DRAGONAIR },
    { TYPE_DARK,     MOVE_BITE,            ITEM_STARF_BERRY, SPECIES_WOBBUFFET },
    { TYPE_FAIRY,    MOVE_DISARMING_VOICE, ITEM_STARF_BERRY, SPECIES_DRAGONAIR },
};
...
SINGLE_BATTLE_TEST("Weakness berries do not decrease the power of Struggle", s16 damage)
{
    ...
    PARAMETRIZE { item = ITEM_STARF_BERRY; }
...
{
    GIVEN {
        ASSUME(GetItemHoldEffect(ITEM_STARF_BERRY) == HOLD_EFFECT_RESIST_BERRY);
        ASSUME(GetItemHoldEffectParam(ITEM_STARF_BERRY) == TYPE_STEEL);
        ASSUME(GetMoveType(MOVE_METAL_CLAW) == TYPE_STEEL);
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_MIMIKYU) { Item(ITEM_STARF_BERRY); Ability(ABILITY_DISGUISE); }
    } WHEN {
