...
ASSUMPTIONS
{
    ...
    ASSUME(gItemsInfo[ITEM_STARF_BERRY].holdEffectParam == TYPE_GROUND);
    ASSUME(gItemsInfo[ITEM_STARF_BERRY].pocket == POCKET_BERRIES);
...
AI_SINGLE_BATTLE_TEST("AI: Belch has nonzero score after eating a berry")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_PIKACHU) { Level(15); Item(ITEM_STARF_BERRY); Moves(MOVE_BELCH, MOVE_SCRATCH); }
    } WHEN {
